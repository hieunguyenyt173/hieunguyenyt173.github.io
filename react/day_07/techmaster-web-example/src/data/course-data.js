...
export const courses = [
    {
        ...
        rating: 5.0,
        topics: ["backend", "database", "devops"],
        price: 9000000,
        supporterId: 3,
    },
    {
    ...
    },
    {
        ...
        description:
            "Phù hợp với học sinh chưa bao giờ code. 3 buổi đầu sử dụng ngôn ngữ Scratch kéo thả trực quan để làm quen với lập trình.",
        type: "onlab",
        image: "https://media.techmaster.vn/api/static/brbgh4451coepbqoch60/bt3miv451co41h2qcnr0",
        rating: 4.5,
        topics: ["backend", "basic"],
        price: 3850000,
        supporterId: 2,
    },
    {
        ...
        description:
            "Bởi qua khoá học này, bạn sẽ được thực hành nhiều và đa dạng từng dịch vụ, sau đó làm những dự án kết hợp nhiều dịch vụ lại với nhau. Cuối cùng khi đã thực hành thành thạo thì mới luyện thi các câu hỏi bộ đề. Mục tiêu không chỉ là thi chứng chỉ mà là áp dụng vào dự án thật.",
        type: "onlab",
        image: "https://media.techmaster.vn/api/static/brbgh4451coepbqoch60/R6t2Z_Op",
        rating: 4.5,
        topics: ["devops", "basic", "database"],
        price: 7000000,
        supporterId: 3,
    },
    {
        ...
        title: "DevOps 2022",
        description:
            "DevOps là một văn hóa làm việc kết hợp giữa kỹ sư phát triển phần mềm (dev) với bộ phận operator (kỹ sư hệ thống, nhân viên bảo mật, kỹ sư mạng, kỹ sư hạ tầng, …) nhằm mục đích rút ngắn vòng đời phát triển sản phẩm",
        type: "onlab",
    ...
    },
    {
        ...
        description:
            "React là một thư viện Javascript được phát triển bởi Facebook, dùng để xây dựng giao diện người dùng. Nó giúp xây dựng các ứng dụng lớn, có nhiều thao tác phức tạp từ người dùng. Rất nhiều trang web lớn đã áp dụng React vào việc xây dựng UI như: facebook.com, wordpress.com, airbnb.com, dropbox.com, …",
        type: "onlab",
    ...
    },
    {
        ...
        description:
            "NodeJS là một công nghệ web đang phát triển nhanh chóng và các lập trình viên NodeJS là một trong những người được trả lương cao nhất trong ngành hiện nay. Nắm vững NodeJS sẽ giúp bạn có một công việc tốt hoặc cải thiện công việc hiện tại bằng cách cho phép bạn xây dựng các ứng dụng web một cách nhanh chóng, mạnh mẽ và chất lượng.",
        type: "online",
        image: "https://media.techmaster.vn/api/static/bub3enc51co7s932dsk0/6PyUoB-T",
        rating: 4.7,
        topics: ["devops", "backend", "database"],
        price: 300000,
        supporterId: 1,
    },
    {
        ...
        description:
            "Các dự án trong khóa học này được thiết kế để giúp bạn xây dựng mọi thứ bằng cách sử dụng HTML5, CSS & JavaScript mà cần sử dụng libraries hay frameworks.",
        type: "online",
    ...
    },
    {
        ...
        description:
            "<ul><li>Sử dụng EXPLAIN / EXPLAIN ANALYZE để phân tích câu query</li><li>Tìm hiểu các phương pháp truy xuất dữ liệu từ bảng: Sequential Scan, Index Scan, Bitmap Scan</li><li>Các phương pháp JOIN: Nested Loop Join, Sort Merge Join, Hash Join</li><li>Sử dụng Index để tăng tốc truy vấn: B-Tree, Hash, Covering, Function-based Index</li><li>Các lý do khiến cho Index bị mất tác dụng khi tiến hành truy vấn và các cách khắc phục</li><li>Một số phương pháp tuning khác</li></ul>",
        type: "online",
        image: "https://media.techmaster.vn/api/static/6734/bo5caps51coco9d0vu80",
        rating: 5,
        price: 500000,
        topics: ["database", "basic"],
        supporterId: 2,
    },
    {
        id: 12,
